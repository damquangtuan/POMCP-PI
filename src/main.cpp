...
int main(int argc, char* argv[])
{
    ...
    desc.add_options()
        ...
        ("hgreedy", value<int>(&searchParams.HGreedy), "Use h-ply rollout action selection")
        ;
...
//command to run pomcp
// ./pomcp --maxdoubles=3 --problem=rocksample --size=7 --number=8 --runs=10 --rolloutknowledge=2
