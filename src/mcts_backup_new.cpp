...
//    double immediateReward, delayedReward = 0, totalReward = 0;
//
//    vector <double> totalRewardVector, tmpList;
//    totalRewardVector.clear();
//    tmpList.clear();
//
//    GreedyQNode tmpQ, maxGreedyQ;
//    maxGreedyQ.action = 0;
//    maxGreedyQ.greedyValue = -2*Infinity;
//
//
//    int historyDepth = History.Size();
//
...
//    }
//
//    maxGreedyQ.totalRewardList = totalRewardVector;
...
GreedyQNode MCTS::ExpandHGreedyDepth(STATE& state, VNODE* vnode, int depth)
{
    ...
    GreedyQNode tmpQ, maxGreedyQ;
    tmpQ.totalRewardList.clear();
    maxGreedyQ.totalRewardList.clear();
...
vector <double> MCTS::SimulateV(STATE& state, VNODE* vnode)
{
    ...
    vector <double> totalRewardVector, tmpVector;
    totalRewardVector.clear();
    tmpVector.clear();
    ...
    totalRewardVector = greedyQ.totalRewardList;
